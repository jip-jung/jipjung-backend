...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<com.jipjung.project.config.exception.ApiResponse<SignupResponse>> signup(
            @Valid @RequestBody SignupRequest request) {
        SignupResponse response = authService.signup(request);
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(com.jipjung.project.config.exception.ApiResponse.success(response));
    }
    ...
    @PostMapping("/login")
    public ResponseEntity<com.jipjung.project.config.exception.ApiResponse<LoginResponse>> login(
